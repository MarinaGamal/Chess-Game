...
public class GameFrame extends JFrame implements ActionListener{
    ...
    public void actionPerformed (ActionEvent e){
        ...
        if (o == itmSave){
            ...
            gg.setTitle("Chess game ver. 1.0");
        ...
        if (queens == 0 && rooks == 0 && pawns == 0){
            if ((knights == 1 && bishops == 0) || (bishops == 1 && knights == 0)){
                ...
                if (choice == 0){
                    ...
                    restratgame.setTitle("Chess game ver. 1.0");
                    restratgame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    restratgame.setBounds(300, 10, 646, 692);
                    restratgame.setResizable(false);
                    restratgame.setVisible(true);
                }else{
                    this.setVisible(false);
                    MenuFrame menu = new MenuFrame();
//                    menu.setTitle("Chess game ver. 1.0");
//                    menu.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//                    menu.setBounds(300, 10, 646, 692);
